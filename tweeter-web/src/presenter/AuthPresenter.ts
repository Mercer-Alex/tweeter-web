...
export abstract class AuthPresenter extends Presenter {
	...
	public async authenticateUser(alias: string, password: string, navigateUrl: string, firstName?: string, lastName?: string, imageBytes?: Uint8Array) {
	...
	protected abstract doAuthentication(alias: string, password: string, firstName?: string, lastName?: string, imageBytes?: Uint8Array): Promise<[User, AuthToken]>;
}
